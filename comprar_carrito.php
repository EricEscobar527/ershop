...
<body>
    ...
    <div class="validar_compra">
        ...
        ?>
            ...
            $consulta = "SELECT id_productos FROM carritos WHERE id_sesion = '$correo'";
            $resultado = $conexion->prepare($consulta);
            $resultado->execute();

            while ($row = $resultado->fetch(PDO::FETCH_ASSOC)) {
                $ids = $row['id_productos'];
            }
            ?>
            ...
            <div class="btn_finalizar_compra">
                ...
                <form action="finalizar_compra_carrito.php?correo=<?php echo $_SESSION['correo']; ?>" method="POST">
                    <input type="hidden" name="ids" value="<?php echo $ids; ?>">
                    <input type="hidden" name="total" value="<?php echo $precios; ?>">
