<?php
  ...
  $actualizar = "INSERT INTO compras(id_sesion, id_productos, cliente, fecha) VALUES('$correo', '$producto', '$cliente', NOW())";
...
<?php
  ...
  $producto_comprado = "SELECT * FROM productos Where id = '$producto'";
